...
export default function ExamPage() {
  ...
  const stats = useMemo(() => {
    const allQuestions = [...problems, ...objectiveQuestions];
      ...
      <div className="exam-layout">
        <aside className="exam-sidebar">
          <div className="exam-side-card">
            ...
            <div className="exam-progress-row">
              <span>코딩</span>
              <strong>{stats.coding}</strong>
            </div>

            <div className="exam-progress-row">
              <span>객관식</span>
              <strong>{stats.objective}</strong>
            </div>
          </div>
            ...
            {objectiveQuestions.length === 0 ? (
              ...
              <div className="exam-objective-card">
                ...
                <button
                  ...
                  className="exam-start-btn"
                  onClick={() =>
                    navigate(`/objective-solve?categoryId=${categoryId}`)
                  }
                >
                  객관식 풀기
                </button>
